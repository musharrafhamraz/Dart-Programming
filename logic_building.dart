...
void main() {
  ...
  */
  ...
  String reverse = word4.split("").reversed.join();

  if (word4.toLowerCase() == reverse.toLowerCase()) {
  ...
  */
  ...
  String word1 = "Musharraf";

  List<String> wordL1 = word1.split("").toList();

  Iterable<String> rWordL = wordL1.reversed;
  ...
  */
  ...
  String numberS = number1.toString();
